...
2. [설계 내용](#2-설계-내용)   
2.1 [설계 계획](#2-설계-)   
2.2 [실제 구현 내용](#2-설계-내용)    
2.2.1 [메뉴 및 기능](#2-설계-내용)  
2.2.2 [서비스 흐름도](#2-설계-내용)     
2.2.3 [CNN 모델링](#2-설계-내용)   
2.2.4 [졸음 예측 모델링 수행](#2-설계-내용)   
2.2.5 [날씨 API 활용](#2-설계-내용)   
2.2.6 [보호자에게 운전자의 상태 전송](#2-설계-내용)  
2.2.7 [개발 환경](#2-설계-내용)  
3. [참고 문헌](#3-참고-문헌)
